  ...
  useEffect(() => {
    const fetchTshirts = async () => {
      try {
        ...
        // Base query for Amazon and Flipkart
        ...
        if (genderFilter === 'men') {
          amazonQuery = amazonQuery
            .or('Description.ilike.%men%,Description.ilike.%male%');
          flipkartQuery = flipkartQuery
            .or('Description.ilike.%men%,Description.ilike.%male%');
        } else if (genderFilter === 'women') {
          amazonQuery = amazonQuery
            .or('Description.ilike.%women%,Description.ilike.%female%');
          flipkartQuery = flipkartQuery
            .or('Description.ilike.%women%,Description.ilike.%female%');
        }
