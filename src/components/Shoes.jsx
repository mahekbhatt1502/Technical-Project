...
const Shoes = () => {
  ...
  const productsData = [
    { name: 'RUNNING SHOES', imageUrl: 'https://via.placeholder.com/150?text=Running+Shoes' },
    { name: 'SNEAKERS', imageUrl: 'https://via.placeholder.com/150?text=Sneakers' },
    { name: 'BOOTS', imageUrl: 'https://via.placeholder.com/150?text=Boots' },
    { name: 'LOAFERS', imageUrl: 'https://via.placeholder.com/150?text=Loafers' },
  ];
