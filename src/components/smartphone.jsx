...
const Smartphone = () => {
  ...
  const productsData = [
    { name: 'IPHONE 14', imageUrl: 'https://via.placeholder.com/150?text=iPhone+14' },
    { name: 'GALAXY S23', imageUrl: 'https://via.placeholder.com/150?text=Galaxy+S23' },
    { name: 'PIXEL 7', imageUrl: 'https://via.placeholder.com/150?text=Pixel+7' },
    { name: 'ONEPLUS 11', imageUrl: 'https://via.placeholder.com/150?text=OnePlus+11' },
  ];
